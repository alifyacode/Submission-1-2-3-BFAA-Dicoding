package com.alifyacode.aplikasikonsumergithub.DatabasesStructure;
...
public class UGthb_DbContract {
    ...
    public static String ctchFavItm(Cursor crsr, String klm){
        return crsr.getString(crsr.getColumnIndex(klm));
    }
}
