...
public class UGthbFol2Fr extends Fragment {
    ...
    private void shwdataFol2ugthb(View vw){
        ...
        Call<List<UsrGthb>> summon = api_srvc.getUsrFol2(Objects.requireNonNull(usr).getLogin());
